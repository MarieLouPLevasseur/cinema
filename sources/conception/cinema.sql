...
ALTER TABLE `casting` ADD CONSTRAINT `casting_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`);
ALTER TABLE `casting` ADD CONSTRAINT `casting_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`);
ALTER TABLE `season` ADD CONSTRAINT `season_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`);
ALTER TABLE `review` ADD CONSTRAINT `review_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`);
ALTER TABLE `review` ADD CONSTRAINT `user_movie_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
